...
namespace MALZEMETAKIPSISTEMI
{
    ...
    public class Turkce
    {
        public static string[] gunler = { "Pazar", "Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi" };
...
namespace MALZEMETAKIPSISTEMI.DevExpressExtentions
{
    ...
    public static class Extention
    {
        public static void GridYazdir(this DevExpress.XtraGrid.GridControl HangiGrid, string Baslik)
        {
            ...
            link.CreateDocument();
            link.ShowPreview(); // yan yazdırmaz için landspace
            link.Dispose();
        }
        ...
        public static void Doldur(this DevExpress.XtraEditors.ComboBoxEdit cmb, string query, string idField, string textField, string codeField, bool firstEmpty)
        {
            ...
            try
            {
                if (firstEmpty)
                {
                    DevCmbBoxItem bosItem = new DevCmbBoxItem(-1, "<<Şeçiniz>>");
        ...
        /// <summary>
        /// verilen ComboBoxEdit kontrolunu aylar (ID,AY) (1..12,Ocak..Aralık) ile doldurur. 
        /// </summary>
        /// <param name="cmb"></param>
        /// <param name="oncekiAyiSec">true önceki ayi seçer,false içinde bulunulan ayi seçer</param>
        /// <returns>ocak ayinda onceki ay seçilirse yilin da değişmesi gerektiğini belirtir</returns>
        ...
        /// <summary>
        /// BarEditItem daki Combobox ları doldurmak için kullanılır
        /// </summary>
        ...
        #endregion
        /// <summary>
        /// virgul yada baska bir simge ile ayrilmis sayilara göre eşleşen list box items lari checkler
        /// </summary>
        ...
        /// <summary>
        /// verilen columnu verilen kontrolun değeriyle karşılaştırır (Devexpress kontrolleri)
        /// </summary>
